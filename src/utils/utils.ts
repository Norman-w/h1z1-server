...
/**
 * NPC 位置更新：含 position、stance、horizontalSpeed；
 * 可选 rotation（四元数）会转为 orientation 供客户端转向。
 *
 * stance 位域关键位：
 *   bit 10 (0x0400 = 1024)  — ON_GROUND
 *   bit 16 (0x10000 = 65536) — FORWARD (移动中)
 * 这些字段是客户端输入；具体动画转换、播放率和步幅仍需原生图验证。
 */
