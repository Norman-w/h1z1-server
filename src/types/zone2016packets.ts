...
// Subtype0x41 has a native blocking parser; NonPriorityCharacters is0x42.
// Byte encoding is verified separately from valid message/map/playback semantics.
export interface CharacterAnimationRequest {
  characterId?: string;
  animation: import("../utils/characterAnimationRequestWire2016").AnimationRequest2016;
}
