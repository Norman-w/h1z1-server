...
| [round-5-playanimation-npc-stub.md](round-5-playanimation-npc-stub.md) | PlayAnimation 静态链进入 NPC `+0x630 → FUN_140532dc0`、`+0x620 → FUN_14053dc30`，旧“空桩”假说已推翻；profile/资源/contact 仍待 live 验证 | ⚠️ 路径成立，运行时效果未闭环 |
